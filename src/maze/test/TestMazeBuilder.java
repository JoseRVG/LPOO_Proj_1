...
public class TestMazeBuilder {
	...
	@Test
	public void testGameConstructorWithRandomMazeValidParameters() throws IllegalArgumentException {
		int[] validSizes = {5,7,9};
		int[] validNumDragons = {0,2,5};
		int numTests = 3;
		for(int i = 0; i < numTests; i++)
		{
			Game game = new Game(Game.DragonMode.IMMOBILE,validSizes[i],validNumDragons[i]);
			assertEquals(validSizes[i],game.getMaze().getMazeCols());
			assertEquals(validSizes[i],game.getMaze().getMazeLins());
		}
	}

	@Test(expected=IllegalArgumentException.class)
	public void testGameConstructorWithRandomMazeTooSmallSize() throws IllegalArgumentException {
		Game game = new Game(Game.DragonMode.IMMOBILE,3);
	}

	@Test(expected=IllegalArgumentException.class)
	public void testGameConstructorWithRandomMazeEvenSize() throws IllegalArgumentException {
		Game game = new Game(Game.DragonMode.IMMOBILE,6);
	}

	@Test(expected=IllegalArgumentException.class)
	public void testGameConstructorWithRandomMazeTooManyDragons() throws IllegalArgumentException {
		Game game = new Game(Game.DragonMode.IMMOBILE,5,2);
	}
